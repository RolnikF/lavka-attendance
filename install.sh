...
print_completion() {
    ...
    echo -e "${GREEN}║${NC}                                                               ${GREEN}║${NC}"
    echo -e "${GREEN}╠═══════════════════════════════════════════════════════════════╣${NC}"
    echo -e "${GREEN}║${NC}  ${WHITE}${BOLD}Автообновление:${NC}                                              ${GREEN}║${NC}"
    echo -e "${GREEN}║${NC}                                                               ${GREEN}║${NC}"
    echo -e "${GREEN}║${NC}  Если вы модифицируете код — отключите автообновление:        ${GREEN}║${NC}"
    echo -e "${GREEN}║${NC}  ${DIM}systemctl stop mireapprove-update.timer${NC}                     ${GREEN}║${NC}"
    echo -e "${GREEN}║${NC}  ${DIM}systemctl disable mireapprove-update.timer${NC}                  ${GREEN}║${NC}"
    echo -e "${GREEN}║${NC}                                                               ${GREEN}║${NC}"
    echo -e "${GREEN}║${NC}  Включить обратно:                                            ${GREEN}║${NC}"
    echo -e "${GREEN}║${NC}  ${DIM}systemctl enable mireapprove-update.timer${NC}                   ${GREEN}║${NC}"
    echo -e "${GREEN}║${NC}  ${DIM}systemctl start mireapprove-update.timer${NC}                    ${GREEN}║${NC}"
    echo -e "${GREEN}║${NC}                                                               ${GREEN}║${NC}"
    echo -e "${GREEN}╚═══════════════════════════════════════════════════════════════╝${NC}"
    echo ""
